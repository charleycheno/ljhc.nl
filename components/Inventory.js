  ...
  return (
    <div className="flex flex-col items-center p-4 pt-16 sm:p-16 bg-neutral-100 dark:bg-neutral-900">
      ...
      <div className="flex flex-col gap-20">
        <Project image="/assets/schoolnotes.ovh.png" year="2024" url="https://schoolnotes.ovh" title="schoolnotes.nl" source="https://github.com/charleycheno/schoolnotes.ovh" technologies={["Vite", "VitePress", "Vue.js", "Markdown"]} description="Een website waar ik aantekeningen maak van belangrijke examenstof." />
